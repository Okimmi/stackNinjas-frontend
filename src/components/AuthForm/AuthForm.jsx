...
import { BackgroundImg, BackgroundImg320, BackgroundImg720, BottleMobil, BottleStyled, ErMsg, FormBtnStyled, SightInContainer, SightUp, StyledBtn, StyledField, StyledForm, Styledlabel } from './AuthForm.styled';
      ...
      <SightInContainer>
        ...
        >
          <StyledForm>
            ...
            <Styledlabel htmlFor="password">Enter your password <StyledBtn onClick={() => setShowPassword(!showPassword)}>
                {showPassword ? (
                  <img
                    src={iconeye}
                    width={18}
